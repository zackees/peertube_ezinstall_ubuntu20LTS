...
exec_shell("sudo -u postgres createdb -O peertube -E UTF8 -T template0 peertube_prod")
...
os.chdir("/var/www/peertube")
exec_shell(f"sudo -u peertube ln -s versions/peertube-${version_str} ./peertube-latest")
